...
class MyString5{
	// 프로그램끼리 메시지를 주고 받을 때, 
	// 가격, 제품명, 수량 --> 한번에 넘겨줘야 (하나의 문자열로 넘기겠다는 말) --> 패킷화
	
	private String packet1 = "SAname=A01price=003000num=001ED";				// 아메리카노 1잔 3000원
	private String packet2 = "SAname=A02price=007000num=002ED";				// 카페라떼 2잔 3500원
	private String packet3 = "SAname=A01price=016000num=004ED";				// 카페모카 4잔 4000원
